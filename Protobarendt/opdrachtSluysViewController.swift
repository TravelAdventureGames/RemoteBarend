//
//  opdrachtSluysViewController.swift
//  Protobarendt
//
...
class opdrachtSluysViewController: UIViewController {
    ...
    @IBAction func button1(sender: AnyObject) {
        ansGiven = true
        whatsMessage("vraag111.png", audio: "error", ext: "wav")
    ...
    @IBAction func button2(sender: AnyObject) {
        ansGiven = true
        whatsMessage("vraag12.png", audio: "error", ext: "wav")
        volgende.enabled = true
        //vraagLabel2.hidden = true
        bu1.enabled = false
        bu2.enabled = false
    ...
    @IBAction func button3(sender: AnyObject) {
        ...
        whatsMessage("vraag13.png", audio: "win", ext: "wav")
        volgende.enabled = true
        //vraagLabel2.hidden = true
        bu1.enabled = false
        bu2.enabled = false
    ...
    override func viewDidAppear(animated: Bool) {
        whatsMessage("vraag1.png", audio: "Barendt", ext: "mp3")
    }
